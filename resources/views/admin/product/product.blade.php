...
<body class="">
  ...
  <div class="flex h-screen overflow-hidden">
    ...
    @endif
        ...
        <thead>
          ...
          <th>Product ID</th>
          <th>Name</th>
          <th>Category ID</th> <!-- Thay đổi tiêu đề -->
          <th>Category Name</th>
  ...
  @if($product->main_image)
    <img src="{{ asset('storage/' . $product->main_image) }}" alt="Product Image" width="80" class="rounded object-cover" />
  @else
    <span>No Image</span>
  @endif
</td>
  ...
  <div class="dropdown dropdown-end ">
    ...
    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow rounded-box w-52 bg-gray-300">
      ...
      <li>
        <a href="{{ route('product.details', ['product_id' => $product->product_id]) }}">➕ Add Detail</a>
